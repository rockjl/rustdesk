...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rockjiang.com"];//&["192.168.1.20"];//&["rs-ny.rustdesk.com"];
pub const PUBLIC_RS_PUB_KEY: &str = "3jZTJal+LrNqvAcTlDKhDACMV90pc+Rwc2hDe6W5zso=";
